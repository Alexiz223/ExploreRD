            ...
            rx.center(
                rx.box(
                    rx.vstack(
                        ...
                        rx.text(
                            "Tu solicitud ha sido procesada por el sistema.",
                            color="#718096",
                            font_size="0.95rem",
                            text_align="center",
                        ),
                ...
                rx.box(
                    rx.hstack(
                        ...
                        rx.vstack(
                            ...
                            rx.text(
                                "Detalles de Estadía y Planificación",
                                font_size="1.25rem",
                                font_weight="700",
                                color="#1a202c",
                            ),
                        ...
                        rx.vstack(
                            ...
                            rx.button(
                                ...
                                _hover={
                                    "background": "#14452b",
                                    "transform": "translateY(-1px)",
                                    "box_shadow": "0 10px 15px -3px rgba(26, 92, 58, 0.3)",
                                },
                                transition="all 0.2s",
